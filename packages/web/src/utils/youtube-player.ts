...
export type PlayerContructorType = new (element: Element | string, options: PlayerOptions) => Player

interface YouTube {
  Player: PlayerContructorType
}
...
export type YouTubeReadyHandler = (PlayerContructor: PlayerContructorType) => void
